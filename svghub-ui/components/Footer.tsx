                ...
                <div className="grid gap-6 md:gap-8 md:grid-cols-5 items-start">
                    ...
                    <div className="md:col-span-2">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-base md:text-lg font-semibold">WaTouKuang</span>
                        </div>
                        <div className="space-y-1.5 text-xs md:text-[13px] text-gray-600 dark:text-gray-400">
                            <p>© {new Date().getFullYear()} watoukuang.com · 保留所有权利</p>
                        </div>
                    </div>
                    ...
                    <div>
                        <ul className="space-y-1 text-sm">
                            <li>
                              <a
                                className="text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white"
                                href="mailto:contact@svghub.org">联系邮箱：contact@watoukuang.com</a>
                            </li>
                            <li>
