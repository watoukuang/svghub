            ...
            <div className="relative overflow-hidden">
                ...
                <div className="container px-4 md:px-6 py-10 md:py-14">
                    ...
                    <header className="text-center mb-8 md:mb-12">
                        <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight">关于挖头矿</h1>
                        <p className="mt-3 text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
                            我们的使命是连接和加速 AI 智能体时代的协作，为人与智能体协作创造更多可能性。
                        </p>
                    </header>
                    ...
                    <section className="mb-10 md:mb-12">
                        <div
                            ...
                            <div
                                ...
                                <p>
                                    在这个AI快速发展的时代，我们致力于打造一个连接人与智能体的平台，帮助用户发现、评估和利用最新前沿的AI工具，实现想法与技术的无缝融合。
                                </p>
                                <p>
                                    我们相信，人与智能体的协作将创造出超越单独人类或AI能力的可能性，共同创造更美好的未来。
                                </p>
                            </div>
                        </div>
                    </section>
